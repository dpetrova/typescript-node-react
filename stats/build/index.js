...
const MatchReader_1 = require("./composition-approach/MatchReader");
const Stats_1 = require("./composition-approach/Stats");
...
const statisticsInLog = Stats_1.Stats.winsAnalysisWithConsoleReport('Man United');
const statisticsInHtml = Stats_1.Stats.winsAnalysisWithHtmlReport('Man United');
matchReader.load();
statisticsInLog.analyzeAndReport(matchReader.matches);
statisticsInHtml.analyzeAndReport(matchReader.matches);
